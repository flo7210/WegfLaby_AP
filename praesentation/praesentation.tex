...
\blocking{\verb~string~-Darstellung des vorhandenen Labyrinths einlesen, Labyrinth lösen! Anschließend mit der Tiefensuche beginnen! (Parallel zum Vortrag laufen lassen.)}
\end{frame}
