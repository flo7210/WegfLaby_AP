...
\blocking{\verb~string~-Darstellung des vorhandenen Labyrinths einlesen, Labyrinth lösen! Anschließend mit der Breitensuche beginnen! (Parallel zum Vortrag laufen lassen.)} 
\end{frame}
...
\begin{frame}[fragile,t]{Praktikumsverlauf ausgehend von der ursprünglichen Planung}
Unseren Zeitplan konnten wir recht gut einhalten. Der dritte Milestone ist wie erwartet aufwendiger geworden, erreicht haben wir ihn erst nach den Klausuren (also Mitte Februar). Hinzugekommen sind (optische) Verbesserungen an der Hardware. \blocking{Letztere zeigen!}

\smallskip
\begin{enumerate}
	\item[3.] \blue{Erkennen des Labyrinths (Breitensuche)}
	\begin{enumerate}
